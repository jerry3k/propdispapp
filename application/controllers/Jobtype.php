...
class Jobtype extends MY_Controller {
	...
	public function load_data() {
		...
		$rows = $this->Jobtype_model->get_jobtype( $xss_clean );
	...
	public function delete() {
		...
		$this->load->model( 'Jobtype_model' );
		$xss_clean = $this->security->xss_clean( $this->input->post() );
		echo $this->Jobtype_model->delete( $xss_clean );
		exit();
	}
	...
	public function status() {
		...
		$this->load->model( 'Jobtype_model' );
		$xss_clean = $this->security->xss_clean( $this->input->post() );
		echo $this->Jobtype_model->status( $xss_clean );
		exit();
	}
